...
def q1():
    ...
    newvalue = value * 312000000
    return '<b>' +(str(newvalue)) + '</b>'

def q2():
    value = d['TEXTHERE2']         # data from research paper
    newvalue = value * 15900000
    return '<b>' + (str(newvalue)) + '</b>'

def q3():
    value = d['TEXTHERE3']           # data from an article
    newvalue = value * 1.27
    return '<b>' + (str(newvalue)) + '</b>'

def q4():
    value = d['TEXTHERE4']         # data from a study
    newvalue = (((value * 2) * 2) * 2)
    return '<b>' + (str(newvalue)) + '</b>'
...
htmlStr += "<html><head><title> Science! </title></head></html>\n"
htmlStr += '<a href= "../science/science"> link back to science questions </a><br>'   # creates a hyperlink
...
if d.has_key('TEXTHERE1') and ctr == 0:       # if theres an input for Q1 then the function add the string onto htmlStr
    ...
    htmlStr += "Q1: " + q1() + " less people would be stuck confined to their beds each year." + "<br><br>"
else:
    info__ += " ,"
...
if d.has_key('TEXTHERE2') and ctr == 0:       # if theres an input for Q2 then the function add the string onto htmlStr
    ...
    htmlStr += "Q2: " + q2() + " less people might contract the flu." + "<br><br>"
else:
    info__ += " ,"
...
if d.has_key('TEXTHERE3') and ctr == 0:       # if theres an input for Q3 then the function add the string onto htmlStr
    ...
    htmlStr += "Q3: They will find " + q4() + " new discoveries every 100 days." + "<br><br>"
else:
    info__ += " ,"
...
if d.has_key('TEXTHERE4') and ctr == 0:       # if theres an input for Q4 then the function add the string onto htmlStr
    ...
    htmlStr += "Q4: The new population of bacteria would be " + q4() + "." + "<br><br>"
else:
    info__ += " ,"
...
if d.has_key('TEXTHERE5') and ctr == 0:      # if theres an input for Q5 then the function add the string onto htmlStr
    ...
    htmlStr += "Q5: English speakers will grow by " + q5() + "% in that time span." + "<br><br>"
else:
    info__ += " ,"
